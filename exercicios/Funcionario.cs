class Funcionario{
    ...
    public void inserirFim(string nome, int idade, string telefone, double salario){
        ...
        if(this.inicio == null && this.fim == null){
            this.inicio = no;
            this.fim = no;
            System.Console.WriteLine("Insira a posição: " + this.fim.nome);
        }else{
            this.fim.noProx = no;
            this.fim = no;
            System.Console.WriteLine("Insira a posição: " + this.fim.nome);
    ...
    public void removerInicio(){
       if(this.inicio == null && this.fim == null){
        System.Console.WriteLine("an empty list");
            ...
            System.Console.WriteLine("Remover a posição: " + this.inicio.nome);
        ...
        if(this.inicio == null && this.fim == null){
            ...
            while(noAux != null){
                if(noAux.noProx == this.fim){
                    System.Console.WriteLine("Remove da posição: " + noAux.noProx.nome);
